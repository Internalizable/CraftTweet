    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            if(args.length == 0) {
                ...
                TwitterPlayer searchedPlayer = twitterCache.getActivePlayer(player.getUniqueId().toString());
            ...
            if(args.length == 1) {
                ...
                if(args[0].equalsIgnoreCase("create")) {
                    ...
                    TwitterPlayer twitterPlayer = twitterCache.getActivePlayer(player.getUniqueId().toString());
                    ...
                    TwitterPlayer requestPlayer = new TwitterPlayer(player.getUniqueId().toString(), config, twitterCache);
            ...
            if(args.length == 2) {
                if(args[0].equalsIgnoreCase("confirm")) {
                    ...
                    TwitterPlayer runningPlayer = twitterCache.getActivePlayer(player.getUniqueId().toString());
                    ...
                    TwitterPlayer waitingPlayer = twitterCache.getWaitingPlayer(player.getUniqueId().toString());
